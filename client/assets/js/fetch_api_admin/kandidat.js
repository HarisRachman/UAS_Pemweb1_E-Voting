    ...
    try {
        ...
        if (output.empty === "empty") {
            ...
            for (var i in output) {
                ...
                <td>${output[i].nama}</td>
                <td><img src="../../client/assets/images/candidates/${output[i].image}" width="auto" height="75px"></td>
                <td>${output[i].visi}</td>
                <td>${output[i].misi}</td>
                <td><button onclick="editKandidat(${output[i].id})" class="btn btn-success">Edit</button>
                <button onclick="deleteKandidat(${output[i].id})" class="btn btn-danger">Delete</button></td>
                </tr>`
            }
        }
        tbody.innerHTML = tr;
