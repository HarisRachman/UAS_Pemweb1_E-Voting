    ...
    try {
        ...
        if (output.empty === "empty") {
            ...
            for (var i in output) {
                ...
                <td><button onclick="editPosition(${output[i].id})" class="btn btn-success">Edit</button>
                <button onclick="deletePosition(${output[i].id})"  class="btn btn-danger">Delete</button></td>
                </tr>`
            }
        }
        tbody.innerHTML = tr;
